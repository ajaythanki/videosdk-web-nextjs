...
import IconStatistic from './svgs/icon-statistic.svg';
import IconChannel from './svgs/icon-channel.svg';
...
export const IconFont = (props) => {
  ...
  return IconComponent ? (
    <IconComponent className={className} style={{ ...(style || {}), pointerEvents: 'none' }} />
  ) : null;
};
